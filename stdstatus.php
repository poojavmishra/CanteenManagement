...
$connect = mysqli_connect("localhost", "", "", "gpmcanteen");
...
<center><h1>All Orders History !</h1> <br>
<h3><a href="student_home.php">Home</a></h3>
 </center>
    <?php
...
$x="order placed";
    include('db/dbh.php') ;
					  $sql="SELECT * FROM booking WHERE uid='".$_SESSION["em"]."' and date='".$dt."';";
