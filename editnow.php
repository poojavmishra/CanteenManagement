...
{   
    ...
    $res= "SELECT * FROM menu WHERE f_id='$mid'";
    $record2=mysqli_query($conn,$res);
                ...
                <form action="addf2a.php" name="myForm" method="post" enctype="multipart/form-data">
                    <div class="col-md-6 ">
                        ...
                        <div class="contact-fields-w3ls">
                            <input type="text" name="fname" placeholder="Food Name" required="" value="<?php echo $fn;?>">
                        </div>
                       <div class="contact-fields-w3ls">
                            <select name="cat" >
                        ...
                        <div class="contact-fields-w3ls">
                            <input type="text" name="price" placeholder="Price" required="" onkeyup="checkInp();" value="<?php echo $pri;?>">
                        </div>
                        <div class="contact-fields-w3ls">
                        ...
                        <div class="contact-fields-w3ls">
                            <br>
                            <input type="hidden" name="midz" value="<?php echo $mid;?>">
