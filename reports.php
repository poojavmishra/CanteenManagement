...
if (isset($_SESSION['admin_loggedin']) && $_SESSION['admin_loggedin'] == true) {
 ...
 $expiry="DELETE FROM my_news WHERE DATEDIFF(NOW() ,date )>30";
 mysqli_query($conn,$expiry);
?>
...
<center><h1>All Customer Records</h1> <br>
<h3><a href="admin_home.php">Home</a> &nbsp;&nbsp;&nbsp; <a href="reports.php">Refresh</a> 
 </center>
    <?php
$x="order placed";
    include('db/dbh.php') ;
