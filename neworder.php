...
<h3><a href="admin_home.php">Home</a> &nbsp;&nbsp;&nbsp; <a href="neworder.php">Refresh</a></h3>
 </center>
    <?php
$x="order placed";
    include('db/dbh.php') ;
...
<form action="ordercomplete.php" method="post"><input type="hidden" name="in" value="<?php echo $row["bid"];?>"> 
